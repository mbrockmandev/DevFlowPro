  ...
  return (
    <>
      <div
        ...
        tabIndex='-1'
        aria-hidden='true'
        className='fixed top-0 left-0 right-0 z-50 w-full p-4 mt-36 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full'>
                ...
                <div className='relative w-full h-16'>
                  ...
                  <div className='absolute bottom-0 right-0 h-18 w-64'>
                    ...
                    <select
                      ...
                      name='status'
                      value={status}
                      className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-30 p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white'
